...
disp=require 'display'  -- to visualize the dataset
...
if opt.visualize then
   ...
   disp.image(first256Samples_y, {title='Y'})
   disp.image(first256Samples_u, {title='U'})
   disp.image(first256Samples_v, {title='V'})
end
